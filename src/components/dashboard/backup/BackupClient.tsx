...
export function BackupClient({ initialStats = null }: BackupClientProps) {
  const [stats, setStats] = useState<BackupStats | null>(initialStats);
    ...
    <div className="space-y-8 w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 bg-primary text-white rounded-xl font-bold hover:bg-primary/90 transition shadow-lg shadow-primary/20 disabled:opacity-50 cursor-pointer"
        >
      ...
      <div className="glass p-6 sm:p-8 rounded-3xl border border-white/5 space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={fetchStats}
            disabled={loading}
            className="p-2 rounded-lg glass glass-hover text-white/70 hover:text-white cursor-pointer disabled:opacity-50"
