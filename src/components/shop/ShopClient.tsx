...
const POINT_PACKAGES = [
  ...
  { id: "pkg_2", points: 500, price: 4.5, name: "500 Points Pro", icon: Rocket, color: "purple", popular: true },
  { id: "pkg_3", points: 1200, price: 10.0, name: "1200 Points Mega", icon: Shield, color: "green", popular: false },
  { id: "pkg_4", points: 3000, price: 24.0, name: "3000 Points Ultimate", icon: Sparkles, color: "primary", popular: false },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {POINT_PACKAGES.map((pkg) => {
            ...
            return (
              <div
                key={pkg.id}
                className={`group relative flex flex-col p-8 rounded-3xl border glass transition-all duration-300 hover:scale-[1.02] ${
                  pkg.popular ? "border-primary/50 shadow-2xl shadow-primary/10" : "border-white/5"
                }`}
              >
                {pkg.popular && (
